...
public class Main extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    FXMLLoader loader
        = new FXMLLoader(getClass().getClassLoader().getResource(Constants.MAIN_FXML), bundle);
    ...
    primaryStage.setScene(new Scene(root, Constants.WINDOW_WIDTH, Constants.WINDO_HEIGHT));
    primaryStage.show();
  }
